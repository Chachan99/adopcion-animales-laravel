                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded-full object-cover" src="{{ $donacion->fundacion->imagen_url ?? asset('img/defaults/fundacion-default.jpg') }}" alt="{{ $donacion->fundacion->nombre }}">
                                    </div>
                                    <div class="ml-4">
